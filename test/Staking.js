...
describe("Staking", function () {
  ...
  describe("Staking", async () => {
    ...
    it("1 month passes", async () => {
      ...
      await time.setNextBlockTimestamp(oneMonthLater);
      await network.provider.send("evm_mine", []);

      const updatedTimestamp = await time.latest();
    ...
    t("Staker1 should approve transfer of 2500 tokens to staking", async () => {
    ...
    t("Staker1 should approve transfer of 1500 tokens to staking", async () => {
